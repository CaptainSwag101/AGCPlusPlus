...
namespace agcplusplus::block2 {
    ...
    class CduChannel {
    public:
        double theta = 33.75 * DEG_TO_RAD / 16; // Radians
        uint16_t read_counter = static_cast<uint16_t>(33.75 / TWENTY_ARCSECONDS / 16);  // Multiplied by 20 arc-seconds to get degrees
