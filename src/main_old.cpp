...
int main(int argc, char* argv[])
{
    ...
    std::string rope_path = mainArgs.get<std::string>("rope");
    ...
    if ((size / 2) != block2::SIZE_FIXED_MEM) {
    ...
    std::array<word, block2::SIZE_FIXED_MEM> rope_data;
